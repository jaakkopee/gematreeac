...
GemaTreeAC is a web application. If you want to clone the repository and run you version of GemaTreeAC, you need to run a http-server on your computer. You also have to install Python3. Python has a module, http.server, that will do for testing the code. Just enter <pre>python3 -m http.server</pre> in the command line in your GemaTreeAC directory and point your browser to 127.0.0.1/GemaTreeAC_index.html.
